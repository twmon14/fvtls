...
This paper presents the formal verification of TLS 1.0 with CiMPG. We use CiMPG to formally verify that: TLS enjoys five properties. All specifications and proofs presented in this paper are available at \url{https://github.com/twmon14/fvtls}.
