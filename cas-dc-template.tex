...
\item The content of Finished messages is not the hash of the security parameters and handshake messages exchanged.
\end{itemize}
% 		\end{verbatim}
% 	\end{small}
