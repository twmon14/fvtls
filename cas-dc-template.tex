...
% an example which shows the order of the equation is important in revising proof scores to succeed formal verification.
	
% to revise proof scores because some case
% splittings cannot be handled by CiMPG, 
% should be divided into smaller open-close fragments because the proof
% scores is too big to be tackled by CiMPG in a reasonable amount of
% time.
