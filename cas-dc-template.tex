...
% 		\end{verbatim}
% 	\end{small}
% 	%constant enemy denotes \verb!enemy!,
% 	\noindent
...
% 	The equations say that a ciphertext \verb!C! is available to \verb!enemy! iff there exists a $\rm Reply$ message whose content is \verb!C!. \verb!rands! can be defined likewise.
...
% 	\end{small}
% 	\noindent
% Among five transitions, \verb!sdcm! and \verb!sdrm! formalize sending $\rm Check$ and $\rm Reply$ messages. The remaining actions \verb!fkcm1!, \verb!fkrm1!, and \verb!fkrm2! are \verb!enemy!'s faking messages.
% , which can be understood as follows:
% 	\begin{itemize}
% 		\item \verb!fkcm1!: a random number \verb!R! is available to \verb!enemy!, \verb!enemy! fakes and sends a $\rm Check$ message using \verb!R!, 
% 		\item \verb!fkrm1!: a ciphertext \verb!C! is available to \verb!enemy!, \verb!enemy! fakes and sends a $\rm Reply$ message using \verb!C!, 
% 		\item \verb!fkrm2!: a random number \verb!R! is available to \verb!enemy!, \verb!enemy! fakes and sends a $\rm Reply$ message using \verb!R!.
% 	\end{itemize}
...
% The remaining transitions \verb!fkcm1!, \verb!fkrm1!, and \verb!fkrm2! are \verb!enemy!'s faking messages, respectively.
% \begin{small}
% \begin{verbatim}
%   op sdcm : Sys Prin Prin Rand -> Sys {constr}
%   op sdrm : Sys Prin Msg -> Sys {constr}
