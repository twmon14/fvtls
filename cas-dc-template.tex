...
In this section, we describe the cases that we encountered during revising proof scores and how we revise them based on CiMPG generated result. Let take a look at the following two equations from the induction case for \verb!sfin! in \verb!7! as follows:
\begin{small}
\begin{verbatim}
