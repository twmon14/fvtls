...
The rest of the paper is organized as follows. Section \ref{pre} describes some preliminaries and section \ref{tls} mentions TLS 1.0 protocol, TLS handshake protocol and the abstract handshake protocol. Section \ref{fstls} presents the formal specification of TLS handshake protocol. Section \ref{fvtls} describes a way to use CiMPG and CiMPA for existing large proof scores in formal verfication. Some related work is mentioned in Section \ref{relatedwork}. Finally, we give our conclusions and some lines of future work in Section \ref{conclusion}.
...
% Please delete this sentence. Instead, please explain inv3, inv5, inv17 and inv18.
